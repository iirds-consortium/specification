...
An <dfn>iiRDS ZIP archive</dfn> is an <a>iiRDS container</a> implementation using a ZIP archive, for example for transport and exchange between systems. The iiRDS ZIP archive is the default implementation of the iiRDS container. All processing applications <em title="MUST in RFC 2119 context" class="rfc2119">MUST</em> support this implementation\. 
